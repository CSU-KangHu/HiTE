...
if __name__ == "__main__":
    ...
    parser.add_argument("--min_sample_threshold", type=int, default=5, help="Minimum sample threshold (default: 5).")
    parser.add_argument("--min_diff_threshold", type=int, default=10, help="Minimum diff threshold (default: 10).")
    ...
    if file_exist(gene_express_table) and file_exist(gene_te_associations):
        ...
        detect_DE_genes_from_TEs_cmd = (
            f"Rscript {script_dir}/detect_DE_genes_from_TEs.R {gene_express_table} {gene_te_associations} --min_sample_threshold {min_sample_threshold} --min_diff_threshold {min_diff_threshold}"
        )
