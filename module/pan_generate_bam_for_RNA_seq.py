...
if __name__ == "__main__":
    ...
    parser.add_argument("--gene_gtf", type=str, help="the gene gtf path.")
    ...
    generate_bam_for_RNA_seq(genome_name, reference, gene_gtf, RNA_seq, threads, RNA_dir, output_dir, log)
