...
def get_full_length_annotation(tmp_output_dir, classified_TE_path, ltr_list, chr_name_map, tir_lib, helitron_lib,
                               nonltr_lib, other_lib, reference, threads, search_struct, log):
    ...
    full_length_annotations, copies_direct = get_full_length_copies_RM(TE_lib, reference, intact_dir, threads,
        ...
        for query_name in full_length_annotations.keys():
            ...
            for copy_annotation in full_length_annotations[query_name]:
                ...
                update_annotation = 'id=te_intact_' + str(
                    intact_count) + ';name=' + query_name + ';classification=' + classification + ';' + annotation
                f_save.write(chr_name + '\t' + 'HiTE' + '\t' + type + '\t' + chr_start + '\t' + chr_end + '\t' + '.\t' +
                             copies_direct[chr_pos] + '\t' + '.\t' + update_annotation + '\n')
...
if __name__ == '__main__':
    ...
    try:
        ...
        get_full_length_annotation(temp_dir, classified_TE_path, ltr_list, chr_name_map, tir_lib, helitron_lib,
                                   nonltr_lib, other_lib, reference, threads, search_struct, log)
