...
if __name__ == '__main__':
    ...
    if is_use_flank_MSA:
        ...
        if not recover or not file_exist(result_file):
            ...
            # is_handle_low_copy = False   # xmh no低拷贝
            ...
            if is_use_deep_model:
                ...
                if not recover or not file_exist(result_file):
                    ...
                    get_high_copy_LTR(output_dir, high_copy_output_dir, copy_num_threshold=5) # xmh 
            ...
            if is_filter_TIR:
                ...
                if not recover or not file_exist(result_file):
                    ...
                    filter_tir_by_tsd(output_path, tsd_output_path, output_dir, threads, log)
                else:
                    log.logger.info(result_file + ' exists, skip...')
