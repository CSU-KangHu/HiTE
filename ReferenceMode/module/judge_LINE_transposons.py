...
if __name__ == '__main__':
    ...
    library_path = os.getcwd() + '/../library/LINEReps.lib'
    temp_dir = tmp_output_dir + '/line_tmp'
    multi_process_LINE(longest_repeats_path, library_path, candidate_LINE_path, blast_program_dir, temp_dir, threads)
