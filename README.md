...
singularity pull HiTE.sif docker://kanghu/hite:3.0.1
...
docker pull kanghu/hite:3.0.1

# run HiTE
docker run -v ${host_path}:${container_path} kanghu/hite:3.0.1 python main.py \
 --genome ${genome} \
 --thread ${thread} \
 --outdir ${output_dir} \
 [other parameters]
 ...
 # e.g., my command: docker run -v /home/hukang:/home/hukang kanghu/hite:3.0.1 python main.py 
 # --genome /home/hukang/HiTE/demo/genome.fa 
 # --thread 40 
 # --outdir /home/hukang/HiTE/demo/test/
```
